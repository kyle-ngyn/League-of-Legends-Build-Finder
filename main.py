...
def ok_button_click(event=None):
    ...
    with sync_playwright() as p:
        ...
        page.wait_for_selector("span.css-ao94tw.e1swkqyq1, span.css-1mbuqon.e1swkqyq2, small, td.css-13jn5d5.e1nwpw1h3, span > em, div.text, span > em > b, td.css-1amolq6.eyczova1 > b")
